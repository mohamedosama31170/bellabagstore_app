...
class BellabagstoreWebViewApp extends StatefulWidget {
  const BellabagstoreWebViewApp({super.key});

  @override
  State<BellabagstoreWebViewApp> createState() => _BellabagstoreWebViewAppState();
}

class _BellabagstoreWebViewAppState extends State<BellabagstoreWebViewApp> {
